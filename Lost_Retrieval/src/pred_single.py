import os,sys
sys.path.append('/cognitive_comp/hejunqing/projects/LongBench')
...
def get_pred(model, tokenizer, data, max_length, max_gen, prompt_format, dataset, device,model_path):
    ...
    for json_obj in tqdm(data):
        ...
        if 'chatglm2' in  model_path: #not in ["lcc", "repobench-p", "trec", "nq", "triviaqa", "lsht"]: # chat models are better off without build prompt on these tasks
