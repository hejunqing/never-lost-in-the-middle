...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',default='/cognitive_comp/liuyibo/cg/pretrain_model/chatglm3-6b-32k',type=str)
    ...
    parser.add_argument('--out_dir',default='pred_chatglm3-6b-32k_retrieval_single',type=str)
